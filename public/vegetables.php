<?php include "../template/header.php";
    ...
    if(empty($checkcate)){
        ...
        Message::ShowMessage("please active or add at least 3 new storages and new file(s) for each to category vegetables");
    }else{
...
<section class="bg">
    <div class="container">
        <form method="post">
            <div class="mx-auto rounded-pill bg-light w-25 border border-primary">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                        ...
                        while ($i < 3) {
                            ?>
                            <div class="col"><input class="button btn btn-info text-black" type="button" name="answers"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="images/star.jpg" width="200px"><br/>
                            <h1>CORRECT!</h1>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer position-relative" style="height: 50px">
                            ...
                            <button type="button" class="btn btn-secondary position-absolute bottom-0 start-50 translate-middle-x"
